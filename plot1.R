...
#21/12/2006;11:23:00;?;?;?;?;?;?;
#********************************************************************************************
#This script is to reconstruct the Global Active Power plot 1 using the base plotting system.
#Final output from this exercise are:
#1. plot1.R script that consist of the R codes that produce the plot
#2. plot1.png which is the plot produced by the code
#
#This plot1.R does the following. 
...
#   as.Date() functions
#4. plot Global Active Power plot 1 and save it to plot1.png file with a width of 480 pixels 
...
## step 2: Set Working Directory to folder where plot1.R was stored
...
############################################################################################
#2.plot Global Active Power plot 1 (plot1.png - 480h x 480w)
############################################################################################
