...
#21/12/2006;11:23:00;?;?;?;?;?;?;
#********************************************************************************************
#This script is to reconstruct the Global Active Power plot 3 using the base plotting system.
#Final output from this exercise are:
#1. plot3.R script that consist of the R codes that produce the plot
#2. plot3.png which is the plot produced by the code
#
#This plot3.R does the following. 
...
#   as.Date() functions
#4. plot Global Active Power plot 3 and save it to plot3.png file with a width of 480 pixels 
...
## step 2: Set Working Directory to folder where plot3.R was stored
...
############################################################################################
#2.plot Global Active Power plot 3 (plot3.png - 480h x 480w)
############################################################################################
